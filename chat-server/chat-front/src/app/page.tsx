...
export default function Home() {
  ...
  return (
    ...
    //     <img className="Image w-[404px] h-[346px] relative rounded-lg" src="https://cdn.theatlantic.com/thumbor/1zSmvW3Hckje87TNIYFSNdMKloI=/1x81:4095x2384/960x540/media/img/mt/2023/02/MCDTITA_FE014/original.jpg" />
    //     <div className="Copy self-stretch h-16 flex-col justify-center items-start gap-1 flex">
    //       <div className="Title self-stretch text-black text-xl font-medium font-['Inter'] leading-[30px]">Title</div>
    //       <div className="Author self-stretch text-zinc-500 text-xl font-medium font-['Inter'] leading-[30px]">Author</div>
    //     </div>
    //   </div>
    //   {/*<!-- Card 2 -->*/}
    //   <div className="Card w-[404px] h-[434px] flex-col justify-start items-start gap-6 inline-flex">
    //     <img className="Image w-[404px] h-[346px] relative rounded-lg" src="https://via.placeholder.com/404x346" />
    //     <div className="Copy self-stretch h-16 flex-col justify-center items-start gap-1 flex">
    //       <div className="Title self-stretch text-black text-xl font-medium font-['Inter'] leading-[30px]">Title</div>
    //       <div className="Author self-stretch text-zinc-500 text-xl font-medium font-['Inter'] leading-[30px]">Author</div>
    //     </div>
    ...
    //   <div className="Titanic self-stretch text-black text-[64px] font-bold font-['Inter']">호현LLM에게 물어보세요!</div>
    // </div>
    // {/*<!-- Navigation 섹션 -->*/}
    ...
    //   <input type="text" placeholder="내용을 입력하세요" className="w-full h-full outline-none bg-transparent" />
    //   <button type="button" className="ml-2 px-4 py-2 bg-gray-800 text-white rounded-lg shadow">버튼</button>
    // </div>
