...
import { deleteByIdAPI, existsIdAPI, findAllUsersAPI, findUserByIdAPI, loginAPI, logoutAPI, modifyAPI } from "./user-api";
...
export const existsId:any = createAsyncThunk(
    "users/exists-id",
    async (username:string) => await existsIdAPI(username)
)
